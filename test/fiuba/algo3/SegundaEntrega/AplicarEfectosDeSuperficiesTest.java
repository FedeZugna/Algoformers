...
public class AplicarEfectosDeSuperficiesTest {
	...
	// NOTA: Sabemos que aplicar efecto afecta Algoformer sin depender de su
	// estado, pero probamos en ambos para garantizarlo.
	...
	public void NebulosaConAlternoQuitaLaVelocidad() {
		// Tal vez para este haga falta meter todo en un contexto de tablero (a
		// confirmar)
		Algoformer ratchet1 = new Ratchet();
		ratchet1.transformar();
		Algoformer ratchet2 = new Ratchet();
	...
	/*
	 * @Test public void EfectoNebulosaDura3Turnos(){ //Tal vez para este haga
	 * falta meter todo en un contexto de tablero (a confirmar) Algoformer
	 * ratchet1 = new Ratchet(); ratchet1.transformar(); Algoformer ratchet2 =
	 * new Ratchet(); ratchet2.transformar(); Superficie nebulosa1 = new
	 * NebulosaDeAndromeda(); nebulosa1.aplicarEfectosSuperficie(ratchet1);
	 * Assert.assertTrue(ratchet1.getVelocidad_despl() == 0); //pasarTurno
	 * Assert.assertTrue(ratchet1.getVelocidad_despl() == 0); //pasarTurno
	 * Assert.assertTrue(ratchet1.getVelocidad_despl() == 0); //pasarTurno
	 * Assert.assertTrue(ratchet1.getVelocidad_despl() ==
	 * ratchet2.getVelocidad_despl()); }
	 */
	@Test
